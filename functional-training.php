<?php $page_title = 'Функциональный тренинг'; ?>
<?php include('header.php'); ?>
	<div class="page-content">
				...
				<div class="row padding-bottom-big">
					<div class="col-lg-6 margin-bottom-large lg-margin-bottom-no">
						<div class="numbered-caption">
							...
							<div class="text">
								<h3 class="tpg-h2">Что мы предлагаем?</h3>
							</div>
						</div>
						<div class="tpg-typography">
							...
							<a href="#" class="btn">Записаться на пробное занятие</a>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="photos-slider">
							<div class="slide">
								<img src="img/temp/ft-slide.jpg" alt="">
							</div>
							<div class="slide">
								<img src="img/temp/ft-slide.jpg" alt="">
							</div>
		...
		<section class="reviews-section section-default-bottom-padding">
			<div class="container">
				<div class="numbered-caption">
					<div class="number">02</div>
					<div class="text">
						<h3 class="tpg-h2">Оборудование для тренировок</h3>
					</div>
				</div>
				<div class="equipment-slider slider-default-paddings slider-dark-arrows">
					<div class="slide">
						<div class="white-card">
							<div class="card-image fullwidth">
								<img src="img/equipment/concept-2.png" alt="">
							</div>
							<div class="card-content text-left">
								<p class="card-caption">Тренажеры Concept 2</p>
								<p>Полная имитация одновременного бесшажного и попеременного лыжных ходов</p>
							</div>
						</div>
					</div>
					<div class="slide">
		...
		<section class="who-we-are-section padding-top-no">
			<div class="container">
				...
				<div class="cards-list columns-3 margin-top-huge coachs-slider slider-default-paddings slider-dark-arrows">
